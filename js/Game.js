...
//title screen
LuwakRunnerGame.Game = function(){};

LuwakRunnerGame.Game.prototype = {
  
	preload: function()
	{
		this.load.image('background2', 'assets/images/back2.png');
	},
	...
	createEnemy: function()
	{
		...
		this.enemy.animations.add('kanan', [5, 6, 7, 8], 7, true);
		
		this.enemy.animations.play('kanan');
	...
	update: function() {
		...
		if (this.game.input.activePointer.justPressed()) {
			...
			this.game.physics.arcade.moveToPointer(this.enemy, this.enemySpeed);
		}
	...
	showLabels: function () 
    {
		...
		var style2 = { font: "20px Arial", fill: "#534646", align: "center" };
		this.scoreLabel2 = this.game.add.text(this.game.width-300, this.game.height - 50, text2, style2);
